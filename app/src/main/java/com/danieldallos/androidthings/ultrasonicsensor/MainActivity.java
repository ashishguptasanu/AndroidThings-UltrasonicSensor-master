        ...
        public boolean onGpioEdge(Gpio gpio) {
            try {
                ...
                if (!gpio.getValue()){
                    ...
                    //final double distance = (pluseWidth / 1000000000.0) * 340.0 / 2.0 * 100.0;
                    double distance = (pluseWidth / 1000.0 ) / 58.23 ; //cm
                    if(distance < 100){
                        t1.speak("Object is near by in the range of" + distance + " centimeters", TextToSpeech.QUEUE_FLUSH, null);
                    }
